...
<div class="encabezado">
    ...
    <a href="home.php" style="color:black;" class="active">Home</a>
    ...
    $directorio = 'Administrador/banner/';
    ...
    echo '<img src="' . $imagen_aleatoria . '" alt="Imagen aleatoria" class="imagen">';
    ?>

    <div style="display: flex; flex-wrap: wrap; justify-content: center;"> 
    <?php
    $query = "SELECT * FROM productos 
              WHERE status = 1 AND eliminado = 0 ORDER BY RAND() LIMIT 4";
    $sql = $con->query($query);
    //$num = $sql->num_rows;
